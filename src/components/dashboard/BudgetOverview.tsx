...
const BudgetOverview = ({ projects }: BudgetOverviewProps) => {
  ...
  const spendingData = [
    { month: 'Jan', planned: 8000, actual: 7200 },
    { month: 'Feb', planned: 16000, actual: 15800 },
    { month: 'Mar', planned: 24000, actual: 26000 },
    { month: 'Apr', planned: 32000, actual: 33500 },
    { month: 'May', planned: 40000, actual: 41200 },
    { month: 'Jun', planned: 48000, actual: totalSpent }
  ];
      ...
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <div className="flex items-center space-x-2">
          <button 
            ...
            className={`px-2 py-1 text-xs rounded ${chartView === 'line' ? 'bg-primary text-primary-foreground' : 'bg-muted'}`}
          >
            Line
          </button>
          <button 
            onClick={() => setChartView('area')} 
            className={`px-2 py-1 text-xs rounded ${chartView === 'area' ? 'bg-primary text-primary-foreground' : 'bg-muted'}`}
          >
            Area
          </button>
        </div>
